    ...
    <>
      ...
      <SectionWrapper className="bg-background">
        <FadeIn>
          <SectionHeader
            badge="Features"
            title="Everything you need to design & deliver"
            subtitle="From compliance checks to CAD-ready exports — in one tool."
          />
        </FadeIn>
      ...
      {/* ── HOW IT WORKS ── */}
      <SectionWrapper className="bg-muted/20 border-y border-border/50">
        <FadeIn>
          <SectionHeader
            badge="How It Works"
            title={`${howItWorksSteps.length} steps from plot to plan`}
            subtitle="Simple. Fast. Built for builders."
          />
        </FadeIn>
      ...
      {/* ── FAQ ── */}
      <SectionWrapper narrow className="bg-muted/20 border-y border-border/50">
        <FadeIn>
      ...
      {/* ── FINAL CTA ── */}
      <SectionWrapper narrow className="overflow-hidden bg-background border-t border-border/50">
        <FadeIn className="text-center">
          <SectionHeader
            badge="Get Started Today"
            title="Ready to plan your first project?"
            subtitle="Sign up free — no credit card required. Start generating NBC-compliant floor plans in minutes."
            className="mb-10"
          />
